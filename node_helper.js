...
module.exports = NodeHelper.create({
  ...
  activateMonitor: function () {
    if (this.config.relayPIN != false) {
	  ...
	  console.log(this.name + " is turning on monitor with brightness: " + this.config.brightness + " and timeout: " + this.config.timeout);
	  exec("python /home/pi/MagicMirror/modules/MMM-PIRArduino/onoff.py " + this.config.brightness + " " + this.config.timeout, null);
	  // "modules/MMM-Podcast/video.mp4"
    }
  },
